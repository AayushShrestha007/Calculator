...
# #defining buttons
# button_1=Button(root,text="1",padx=40,pady=20,command=lambda : button_click(1)) #Using lambda to pass arguements
...
# button_divi=Button(root,text="/",padx=39,pady=20,command=button_divi)
